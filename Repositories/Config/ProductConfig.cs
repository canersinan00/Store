    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 6,CategoryId=1, ImageUrl ="/images/6.jpg",ProductName = "History Book", Price = 25,ShowCase=false },
                ...
                new Product() { ProductId = 9,CategoryId=2, ImageUrl ="/images/9.jpg",ProductName = "Galaxy FE", Price = 4500,ShowCase=true },
